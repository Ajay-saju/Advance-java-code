...
public class PrintArrayElements {
    ...
    // Hint for the learner - print space after each element,don't print newline
    // after the last element.

    // TODO: Implement the 'printArray' method here

    // The method template below is written for integer arrays only. You are
    // required to implement it for arrays of any data type.
    ...
    public static <U> void printArray(U[] arr) {
